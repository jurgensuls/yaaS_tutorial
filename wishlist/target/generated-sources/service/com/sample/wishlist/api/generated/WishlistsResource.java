...
public interface WishlistsResource
{
	...
	Response get(@javax.ws.rs.BeanParam @javax.validation.Valid final PagedParameters paged, @javax.ws.rs.BeanParam @javax.validation.Valid final YaasAwareParameters yaasAware);
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Produces({"application/json"})
	Response getByWishlistIdWishlistItems(@javax.ws.rs.BeanParam @javax.validation.Valid final PagedParameters paged, @javax.ws.rs.BeanParam @javax.validation.Valid final YaasAwareParameters yaasAware, @javax.ws.rs.PathParam("wishlistId") final java.lang.String wishlistId);
